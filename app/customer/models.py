...
class Cart(models.Model):
    ...
    stores_id = models.ForeignKey(Store, on_delete=models.CASCADE, verbose_name='stores_id')
    menus_id = models.ForeignKey(Menus, on_delete=models.CASCADE, verbose_name='menus_id')
